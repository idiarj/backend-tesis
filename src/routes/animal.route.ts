...
animalRouter.post('/', authenticationMidd,  authorizationMidd(Perfil.VET_ADMIN, Perfil.ADMIN, Perfil.VET), upload.single('catPhoto'), AnimalController.AnimalPOST);
...
animalRouter.delete('/:id_animal', authenticationMidd, authorizationMidd(Perfil.VET_ADMIN, Perfil.ADMIN, Perfil.VET), AnimalController.AnimalDELETE);
